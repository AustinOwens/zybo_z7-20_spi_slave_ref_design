...
#
# 1_build-zybo-z720-spi-ref-design.tcl: Tcl script for re-creating project '1_build-zybo-z720-spi-ref-design'
#
# Generated by Vivado on Sat Jan 20 20:03:22 -0800 2024
...
#
# 1. This project restoration tcl script (1_build-zybo-z720-spi-ref-design.tcl) that was generated.
#
...
set _xil_proj_name_ "zybo-z720-spi-ref-design"
...
set script_file "zybo-z720-spi-ref-design"
...
\
  ...
  set_property -dict [list \
    CONFIG.Async_Clk {0} \
    CONFIG.C_BYTE_LEVEL_INTERRUPT_EN {1} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_FULL]
  ...
  connect_bd_net -net ACLK_1 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_quad_spi_0/s_axi4_aclk] [get_bd_pins ila_0/clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk]
  connect_bd_net -net axi_quad_spi_0_io1_o [get_bd_pins axi_quad_spi_0/io1_o] [get_bd_pins processing_system7_0/SPI0_MISO_I] [get_bd_pins ila_0/probe1]
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins axi_quad_spi_0/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins ila_0/probe4]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi4_aresetn]
  ...
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_pins processing_system7_0/SPI0_MOSI_O] [get_bd_pins axi_quad_spi_0/io0_i] [get_bd_pins ila_0/probe0]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_pins processing_system7_0/SPI0_SCLK_O] [get_bd_pins axi_quad_spi_0/sck_i] [get_bd_pins ila_0/probe2]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_pins processing_system7_0/SPI0_SS_O] [get_bd_pins axi_quad_spi_0/spisel] [get_bd_pins ila_0/probe3]
  connect_bd_net -net processing_system7_0_SPI1_MOSI_O [get_bd_pins processing_system7_0/SPI1_MOSI_O] [get_bd_pins ila_0/probe6]
  connect_bd_net -net processing_system7_0_SPI1_SCLK_O [get_bd_pins processing_system7_0/SPI1_SCLK_O] [get_bd_pins ila_0/probe5]
  connect_bd_net -net processing_system7_0_SPI1_SS_O [get_bd_pins processing_system7_0/SPI1_SS_O] [get_bd_pins ila_0/probe7]

  # Create address segments
  assign_bd_address -offset 0x41E00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_quad_spi_0/aximm/MEM0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-304,-186",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1350 -y 340 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1350 -y 360 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y 480 -defaultsOSRD
preplace inst axi_quad_spi_0 -pg 1 -lvl 3 -x 980 -y 150 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -x 670 -y 120 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 240 -y 150 -defaultsOSRD
preplace inst ila_0 -pg 1 -lvl 4 -x 1240 -y 200 -defaultsOSRD
preplace netloc ACLK_1 1 0 4 30 250 440 280 850 20 1150
preplace netloc axi_quad_spi_0_io1_o 1 1 3 470 270 860J 40 1130
preplace netloc axi_quad_spi_0_ip2intc_irpt 1 0 4 40 260 NJ 260 830J 30 1100
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 520 240 840
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 20 680 440
preplace netloc processing_system7_0_SPI0_MOSI_O 1 1 3 450 250 820J 10 1140
preplace netloc processing_system7_0_SPI0_SCLK_O 1 1 3 460 290 NJ 290 1120
preplace netloc processing_system7_0_SPI0_SS_O 1 1 3 490 300 NJ 300 1110
preplace netloc processing_system7_0_SPI1_SCLK_O 1 1 3 500 310 NJ 310 1130J
preplace netloc processing_system7_0_SPI1_MOSI_O 1 1 3 510 320 NJ 320 1140J
preplace netloc processing_system7_0_SPI1_SS_O 1 1 3 520 330 NJ 330 1150J
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 N 120
...
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 480 60n
levelinfo -pg 1 0 240 670 980 1240 1350
pagesize -pg 1 -db -bbox -sgen 0 0 1470 690
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zybo_z720_spi_ref_design.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
